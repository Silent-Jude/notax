...
<template>
  <div class="yxskqr">
    ...
    <div class="bill-wrap">
      <div class="bill">
        ...
        <div class="row-three">
          ...
          <input id="" :checked="colTrade.collected == 1" type="checkbox" disabled name="">
          <input id="" :checked="colTrade.derated == 1" type="checkbox" disabled name="">
    ...
    <!-- 选择打印模板组件 -->
    <templateSelect :template-list="templateDataList" :form-print-data="billPrintData" :table-print-data="tablePrintData"/>
  ...
  data() {
    return {
      ...
      templateInitData: {
        ...
        templatecontent: {
          lodopPrintStr: `
this.LODOP.PRINT_INITA(0,-32,800,600,"套打样式初始化设置");
...
this.LODOP.SET_SHOW_MODE("BKIMG_WIDTH","205.58mm");
this.LODOP.SET_SHOW_MODE("BKIMG_HEIGHT","102.13mm");
this.LODOP.SET_SHOW_MODE("BKIMG_IN_PREVIEW",true);
this.LODOP.ADD_PRINT_TEXTA("填制日期（年）",52,134,33,19,"填制日期（年）");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("填制日期（月）",53,175,41,19,"填制日期（月）");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("填制日期（日）",53,212,33,23,"填制日期（日）");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("执收单位",76,136,219,24,"执收单位");
this.LODOP.ADD_PRINT_TEXTA("执收单位编码",56,608,80,24,"执收单位编码");
this.LODOP.ADD_PRINT_TEXTA("组织机构代码",76,608,80,24,"组织机构代码");
this.LODOP.ADD_PRINT_TEXTA("付款人全称",98,175,201,24,"付款人全称");
this.LODOP.ADD_PRINT_TEXTA("付款人账号",120,175,203,24,"付款人账号");
this.LODOP.ADD_PRINT_TEXTA("付款人开户银行",143,175,201,24,"付款人开户银行");
this.LODOP.ADD_PRINT_TEXTA("收款人全称",98,499,202,24,"收款人全称");
this.LODOP.ADD_PRINT_TEXTA("收款人账号",121,499,203,24,"收款人账号");
this.LODOP.ADD_PRINT_TEXTA("收款人开户银行",144,499,202,24,"收款人开户银行");
this.LODOP.ADD_PRINT_TEXTA("金额（大写）",167,156,129,24,"金额（大写）");
this.LODOP.ADD_PRINT_TEXTA("金额（小写）",169,519,166,24,"金额（小写）");
this.LODOP.ADD_PRINT_TEXTA("效验码",361,157,143,24,"效验码");
this.LODOP.ADD_PRINT_TEXTA("项目编码1",209,68,75,24,"项目编码1");
this.LODOP.ADD_PRINT_TEXTA("收入项目名称1",210,143,244,24,"收入项目名称1");
this.LODOP.ADD_PRINT_TEXTA("单位1",211,392,53,24,"单位1");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("收缴标准1",210,518,69,24,"收缴标准1");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("数量1",210,453,58,24,"数量1");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("金额1",210,593,104,24,"金额1");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",3);
this.LODOP.ADD_PRINT_TEXTA("项目编码2",234,68,75,23,"项目编码2");
this.LODOP.ADD_PRINT_TEXTA("收入项目名称2",235,143,243,24,"收入项目名称2");
this.LODOP.ADD_PRINT_TEXTA("单位2",234,392,53,24,"单位2");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("数量2",234,453,59,24,"数量2");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("收缴标准2",233,518,69,24,"收缴标准2");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("金额2",233,593,105,24,"金额2");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",3);
this.LODOP.ADD_PRINT_TEXTA("项目编码3",256,68,75,24,"项目编码3");
this.LODOP.ADD_PRINT_TEXTA("收入项目名称3",259,143,242,24,"收入项目名称3");
this.LODOP.ADD_PRINT_TEXTA("单位3",256,392,53,24,"单位3");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("数量3",258,454,59,24,"数量3");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("收缴标准3",256,518,70,24,"收缴标准3");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("金额3",257,593,105,24,"金额3");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",3);
this.LODOP.ADD_PRINT_TEXTA("项目编码4",281,68,75,24,"项目编码4");
this.LODOP.ADD_PRINT_TEXTA("收入项目名称4",282,143,242,24,"收入项目名称4");
this.LODOP.ADD_PRINT_TEXTA("单位4",280,392,54,24,"单位4");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("数量4",280,453,59,24,"数量4");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("收缴标准4",279,518,71,24,"收缴标准4");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
this.LODOP.ADD_PRINT_TEXTA("金额4",281,593,106,24,"金额4");
this.LODOP.SET_PRINT_STYLEA(0,"Alignment",3);
this.LODOP.ADD_PRINT_TEXTA("备注",305,489,208,43,"备注");
          `,
  ...
  computed: {
    ...
    formPrintData() {
      ...
      return (
        [
          { key: 1, label: '填制日期（年）', prop: 'year', value: (this.colTrade.billdate ? this.colTrade.billdate.substring(0, 4) : this.colTrade.billdate) },
          { key: 2, label: '填制日期（月）', prop: 'month', value: (this.colTrade.billdate ? this.colTrade.billdate.substring(5, 7) : this.colTrade.billdate) },
          { key: 3, label: '填制日期（日）', prop: 'date', value: (this.colTrade.billdate ? this.colTrade.billdate.substring(8, 10) : this.colTrade.billdate) },
          { key: 4, label: '执收单位', prop: 'unit', value: this.agency.agencyname },
          { key: 5, label: '大厅编码', prop: 'hallCode', value: this.colTrade.hallno },
          { key: 6, label: '执收单位编码', prop: 'unitCode', value: this.agency.agencycode },
          { key: 7, label: '组织机构代码', prop: 'organizationCode', value: null }, // this.agency.orgcode
          { key: 8, label: '付款人全称', prop: 'payName', value: this.colTrade.payer },
          { key: 9, label: '付款人账号', prop: 'payAccount', value: this.colTrade.payerbankacctno },
          { key: 10, label: '付款人开户银行', prop: 'payBank', value: this.colTrade.payeracctbank },
          { key: 11, label: '收款人全称', prop: 'receivName', value: this.bank.chgagencyacctname },
          { key: 12, label: '收款人账号', prop: 'receivAccount', value: this.bank.chgagencybankaccount },
          { key: 13, label: '收款人开户银行', prop: 'receivBank', value: this.bank.chgagencybankname },
          { key: 14, label: '金额（大写）', prop: 'amountWord', value: this.Arabia_To_Chinese },
          { key: 15, label: '金额（小写）', prop: 'amountNumber', value: this.getComma },
          { key: 16, label: '效验码', prop: 'checkNumber', value: this.colTrade.safecode },
          { key: 17, label: '开票人', prop: 'billMan', value: this.colTrade.drawer },
          { key: 18, label: '审核人', prop: 'auditMan', value: this.colTrade.auditor },
          { key: 19, label: '作废人', prop: 'abolishMan', value: this.colTrade.canceller },
          { key: 20, label: '收款人', prop: 'receiver', value: this.colTrade.payee },
          { key: 21, label: '备注', prop: 'remark', value: this.colTrade.remark }
        ]
      )
    },
    billPrintData() {
      // return this.formPrintData.push(...this.getBillPrintData())
      var billDetailArray = []
      var keyNum = 22
      var billPrintHead = ['项目编码', '收入项目名称', '单位', '数量', '收缴标准', '金额']
      for (var i = 1; i <= 4; i++) {
        var item = this.tablePrintData[i - 1]
        if (item) {
          // 返给我的item是全部的数据字段，太多了。
          // item存在时
          for (var key in item) {
            switch (key) {
              case 'nontaxcode':
                billDetailArray.push({
                  key: keyNum++, label: '项目编码' + i, prop: key, value: item[key]
                })
                break
              case 'nontaxname':
                billDetailArray.push({
                  key: keyNum++, label: '收入项目名称' + i, prop: key, value: item[key]
                })
                break
              case 'chargeunit':
                billDetailArray.push({
                  key: keyNum++, label: '单位' + i, prop: key, value: item[key]
                })
                break
              case 'num':
                billDetailArray.push({
                  key: keyNum++, label: '数量' + i, prop: key, value: item[key]
                })
                break
              case 'chargelower':
                billDetailArray.push({
                  key: keyNum++, label: '收缴标准' + i, prop: key, value: item[key] + '-' + item['chargelimit']
                })
                break
              case 'amt':
                billDetailArray.push({
                  key: keyNum++, label: '金额' + i, prop: key, value: item[key]
                })
                break
            }
          }
          ...
          for (var j = 0; j < 6; j++) {
            billDetailArray.push({
              key: keyNum++, label: billPrintHead[j] + i, prop: '', value: ''
            })
          }
        }
      }
      // this.tablePrintData.forEach((item, i) => {
      // billDetailArray.push({
      //   key:1,label:,prop:,value:item
      // })

      // })
      billDetailArray.unshift(...this.formPrintData)
    ...
    // 单位 chargeunit
    // 数量 num
    // 标准 chargelower-chargelimit
    // 金额 amt
    // tablePrintData: [], // 这个是票据表格的打印列表，数据是什么？
    tablePrintData() {
      // this.projectList
      // this.colTrade.colTradeDetails.colTradeDetail
      var arr = []
      if (this.projectList.length > 0) {
        arr = this.projectList.map((item, index) => {
          item.num = this.colTrade.colTradeDetails.colTradeDetail[index].num
          item.amt = this.colTrade.colTradeDetails.colTradeDetail[index].amt
          return item
        })
      }
      // console.log('arr', arr)
  ...
  methods: {
    ...
    checkCouldPrint() {
      if (this.projectList.length === 0) {
        Bus.$emit('alert', `没有可打印的票据信息！`)
        this.couldPrint = false
        return
      } else {
        this.couldPrint = true
      }
      if (this.audited === '01' || +this.audited !== 1) {
        Bus.$emit('alert', `该缴款书尚未审核，不能进行开票预览或打印！`)
        this.couldPrint = false
        return
      } else {
        this.couldPrint = true
    ...
    preview() {
      this.checkCouldPrint()
      if (this.couldPrint) {
        Bus.$emit('billPrintPreview')
      }
    },
    setup() {
      console.log(this.billPrintData)
      Bus.$emit('openTemplateDialog')
    },
    exportExcel() {
      this.checkCouldPrint()
      if (this.couldPrint) {
    ...
    query() {
      ...
      this.$refs.query.form = {
        ...
        billStartDate: `${time.getFullYear()}-${time.getMonth()}-${time.getDate() + 1}`,
        chargeEndDate: `${time.getFullYear()}-${time.getMonth() + 1}-${time.getDate()}`,
        // chargeStartDate: `${time.getFullYear()}-${time.getMonth() + 1}-1`,
        chargeStartDate: `${time.getFullYear()}-${time.getMonth()}-${time.getDate() + 1}`,
        flag: 0,
        pageIndex: 1,
        pageSize: 10,
        payBillNo: '', // 23,21
