...
export default {
  ...
  data() {
    return {
      data: [],
      refreshTree: true,
      urlPath: '/bas/basBankfrontmac',
      clientButnsArray: ['close', 'refresh', 'save', 'abolish', 'tablePrintPreview', 'tablePrint', 'tablePrintSet', 'tablePrintExport', 'update', 'add', 'delete', 'tablePrint', 'tablePrintSet', 'tablePrintExport'], // 这里填写那些服务器没有返回，但是却在按钮组中存在的按钮。
      // listInfo的表头，需要手动传进去。
      listInfoTableHead: [
        { label: '银行编码', prop: 'basRemittedbank.bankcode', width: 150 },
        { label: '银行名称', prop: 'bankname', width: 150 },
        { label: '设置1001交易', prop: 'bank1001', width: 150 },
        { label: '设置6001交易', prop: 'bank6001', width: 150 },
        { label: '前置机协议版本号', prop: 'version', width: 150 },
        { label: '是否采用压缩格式上传标志', prop: 'backfileextmark', width: 150 },
        { label: '审核标志', prop: 'auditedmark', width: 150 },
        { label: '对账待查确认标志', prop: 'accconfirmmark', width: 150 }
      ]
    }
  },
