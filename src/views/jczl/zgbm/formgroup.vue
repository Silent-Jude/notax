      ...
      <el-row>
        <el-col :span="16">
          <el-form-item label="主管部门代码" prop="deptcode">
            <el-input v-model="form.deptcode" :disabled="$store.getters.savestate===0" @focus="clearValidate"/>
          </el-form-item>
        </el-col>
        <el-col :span="8"><el-form-item label="外部编码" prop="foreigncode">
          <el-input v-model="form.foreigncode" :disabled="$store.getters.savestate===0" @focus="clearValidate"/>
        </el-form-item>
        </el-col>
      </el-row>
      <el-form-item label="主管部门名称" prop="deptname">
        <el-input v-model="form.deptname" :disabled="$store.getters.savestate===0" @focus="clearValidate"/>
      </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        // 定义规则。
        deptcode: [
          { required: true, message: '主管部门代码不能为空！', trigger: 'blur' },
