<!--pjfz 票据废止 -->
<template>
  <el-scrollbar class="pjfz" style="height:100%;width:100%;">
    <div class="pjfz">
          ...
          <el-col :span="3">
            <el-form-item label="" label-width="0px">
              <el-select :disabled="!form.isfilter" v-model="form.filterName" placeholder="">
                ...
                <el-option label="废止日期" value="repealdate"/>
      ...
      <!-- 添加对话框 0=0-->
      <add ref="layer1" :form="currentRowState" title="财政票据废止"/>
      <!-- 请选择票据种类信息 -->
...
export default {
  ...
  data() {
    ...
    // 审核
      ...
      addLayerForm: {
        repealdate: formatDate(new Date()), // 业务日期
        receipno: '', // 单据编码
        operator: '', // 制单人
        delivered: '', // 送审人
        reviewer: '', // 审核人
  ...
  methods: {
    ...
    dbRow() {
      ...
      this.$refs.layer1.submitData.repeal = this.currentRow
      this.$refs.layer1.submitData.bilRepealDetails.bilRepealDetail = this.currentRow.details

      this.$refs.layer1.selectedBasChargeAgency = {}

      this.$refs.layer1.backBillStorageName = this.currentRow.storagename

      this.$refs.layer1.selectedBasChargeAgency.guid = this.currentRow.storeid
    ...
    billUpdate() {
      if (this.currentRow.auditmark === '1') {
        ...
        // this.$refs.layer1.submitData.repeal.guid = this.currentRow.guid
    ...
    basBillInfoSelect(datas) {
      ...
      // this.billName = datas.currentRow.storagename
      this.billName = datas.currentRow.billname
