...
<template>
  <el-scrollbar style="height:100%;width:100%;">
    <div class="pjxh">
          ...
          <el-col :span="3">
            <el-form-item label="" label-width="0px">
              <el-select :disabled="!form.isfilter" v-model="form.filterName" placeholder="">
                ...
                <el-option label="销毁日期" value="destorydate"/>
          ...
          <el-col :span="9">
            <el-form-item label="票据名称">
              <el-input
                ...
                clearable
                placeholder="请选择票据种类" >
                <el-button slot="append" icon="el-icon-caret-bottom" @click="showBillInfo()"/>
              </el-input>
            </el-form-item>
          </el-col>
      ...
      <!-- 添加对话框 -->
      <add ref="layer1" :form="currentRowState" title="已核销票据销毁"/>
      <!-- 票据名称对话框 -->
...
export default {
  ...
  data() {
    ...
    // 审核
      ...
      addLayerForm: {
        destorydate: formatDate(new Date()), // 销毁日期
        receipno: '', // 单据编码
        operator: '', // 制单人
        delivered: '', // 送审人
        reviewer: '', // 审核人
        attn: '', // 经手人addLayerForm
        reason: '' // 原因
      }
    }
  },
  ...
  methods: {
    ...
    dbRow() {
      ...
      this.$refs.layer1.submitData.destory = this.currentRow
      this.$refs.layer1.submitData.bilDestoryDetails.bilDestoryDetail = this.currentRow.details
      // this.$refs.layer1.submitData.destory.guid = this.currentRow.guid
      this.$refs.layer1.agency2billInfoCurrent = []
      this.$refs.layer1.storagename = this.currentRow.storagename
    ...
    // getParamsByAgencyname(storagename, sourceArray) {
    //   sourceArray.find()
    // },
    // 修改
    billUpdate() {
    ...
    add() {
      ...
      this.addLayerForm = {
        destorydate: formatDate(new Date()), // 业务日期
        receipno: '', // 单据编码
        operator, // 制单人
        reviewer: '', // 审核人
        attn: '', // 经手人
      ...
      // this.$refs.layer1.form.destorydate = formatDate(new Date())
    ...
    getSelect(datas) {
      ...
      // this.basChargeagency = datas.currentRow.storagename
      this.basChargeagency = datas.currentRow.billname
