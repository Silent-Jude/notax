...
<template>
  <el-scrollbar style="height:100%;width:100%;">
    <div class="pjlysq">
        ...
        <el-scrollbar style="height:100%;width:100%;">
          <el-table
            ...
            <el-table-column
              ...
              align="center"
              label="发票标记">
              <template slot-scope="scope"><el-checkbox :checked=" scope.row.mark != 0 " disabled/></template>
            </el-table-column>
            <el-table-column
              prop="personnel"
              sortable
      ...
      <!-- 添加对话框 -->
      <add ref="layer1" :form="currentRowState" title="票据领用申请"/>
      <!-- 请选择执收单位 -->
...
export default {
  ...
  methods: {
    ...
    dbRow() {
      ...
      this.$refs.layer1.submitData.agencyPurchase = this.currentRow
      this.$refs.layer1.submitData.bilAgencyPurchaseDetails.bilAgencyPurchaseDetail = this.currentRow.details
      // this.$refs.layer1.submitData.agencyPurchase.guid = this.currentRow.guid
    ...
    add() {
      ...
      this.$refs.layer1.submitData.agencyPurchase.approvalmark = 0
