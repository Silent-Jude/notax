...
<template>
  <el-scrollbar style="height:100%;width:100%;">
    <div class="zypjhxgl">
          ...
          <el-col :span="3">
            <el-form-item label="" label-width="0px">
              <el-select :disabled="!form.isfilter" v-model="form.filterName" placeholder="">
                ...
                <el-option label="填制日期" value="filldate"/>
      ...
      <!-- 添加对话框 -->
      <add ref="layer1" :form="currentRowState" title="银行代收票据作废"/>
      <!-- 请选择票据种类信息 -->
...
export default {
  ...
  data() {
    return {
      ...
      addLayerForm: {
        filldate: formatDate(new Date()), // 业务日期
        receipno: '', // 单据编码
        operator: '', // 制单人
        delivered: '', // 送审人
        reviewer: '', // 审核人
  ...
  methods: {
    ...
    dbRow() {
      ...
      this.$refs.layer1.submitData.invalid = this.currentRow
      this.$refs.layer1.submitData.bilInvalidDetails.bilInvalidDetail = this.currentRow.details
    ...
    add() {
      ...
      this.$refs.layer1.selectedBasChargeAgency = {}
      this.$refs.layer1.basChargeAgencyName = ''

      this.$refs.layer1.submitData.invalid.approvalmark = 0
