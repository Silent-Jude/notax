<!-- dwpjkccx 单位票据库存查询 -->
<template>
  <el-scrollbar class="dwpjkccx" style="height:100%;width:100%;">
    <div class="pjyztzs">
          ...
          <el-col :span="10">
            <el-form-item label-width="80px" label="">
              <el-radio-group v-model="type2">
                <el-radio label="1">全部</el-radio>
                <el-radio label="2">市值</el-radio>
                <el-radio label="3">县市区</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  created() {
    ...
    // 获取当前表格数据
    this.queryAgencyBillStore(this.form)
  },
  ...
  methods: {
    ...
    dbRow() {
      ...
      this.queryAgencyBillStoreDetail(this.currentRow)
      // .then(res => {
    ...
    // 获取表格数据方法
    queryAgencyBillStore: pjkccx.queryAgencyBillStore,
    // 明细数据方法
    queryAgencyBillStoreDetail: pjkccx.queryAgencyBillStoreDetail,
    // 查看表格一行对应数据方法
