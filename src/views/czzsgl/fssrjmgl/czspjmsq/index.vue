...
export default {
  ...
  methods: {
    postBillAudit: fssrjmgl.billAudit,
    // 审核 对话框
    billAudit() {
    ...
    add() {
      ...
      // this.$refs.layer1.currentRow.coltrade = {}
      // this.$refs.layer1.currentRow.coltrade.paybillno = ''
      // this.$refs.layer1.currentRow.details = []

      // this.$refs.layer1.currentRow.writedate = `${time.getFullYear()}-${(time.getMonth() + 1)}-${time.getDate()}`
      // this.$refs.layer1.currentRow.writedate = new Date()
      // 设置编辑状态
      this.$refs.layer1.state = true
    },
    // 修改
