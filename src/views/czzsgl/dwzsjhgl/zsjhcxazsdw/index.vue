<template>
  <div class="zsjhcx">
    ...
    <!-- 执收单位 -->
    <layer ref="layer" :tb-head="tbHead" :form="formzsdw" :table-data="zsdwData" title="请选择执收（罚）单位" @select="getSelect"/>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      dwzsjhgl.findColPlanUnitAndCurrency(this.form).then(res => {
