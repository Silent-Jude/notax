          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <el-input v-else-if="state && (currentRow.carrydownrequired === '1' || currentRow.carrydownrequired === 'true') && item.prop === 'prevyearnum'" v-model="scope.row.prevyearnum" size="mini" @input.native="inputchange(scope)"/>
                <el-input v-else-if="state && (currentRow.imposerequired === '1' || currentRow.imposerequired === 'true') && item.prop === 'planamt'" v-model="scope.row.planamt" size="mini" @input.native="inputchange(scope)"/>
...
export default {
  ...
  data() {
    return {
      ...
      // 工具条
      clientButnsArray: ['czbillClose', 'czbillUpdate2', 'czbillDelete', 'czbillSave', 'czbillAbolish',
        'czbillSendAudit', 'czbillAdd2', 'tablePrintPreview', 'print', 'export', 'tablePrintSet'],
      // 是否显示
