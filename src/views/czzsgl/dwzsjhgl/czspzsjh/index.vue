<template>
  <div class="dwlrdzsq">
    <toolBar :get-current-row="Object.assign({audited:currentRow.auditmark},currentRow)" :client-butns-array="clientButnsArray" />
    <h1>单位征收计划管理</h1>
...
export default {
  ...
  data() {
    return {
      ...
      // 工具条按钮组
      clientButnsArray: ['close', 'czbillUpdatef', 'czbillAddAudit', 'czbillUnaudit', 'czbillRefresh', 'tablePrintPreview', 'print', 'export', 'tablePrintSet'],
      form: {
        totalCount: 0,
        pageSize: 10,
        pageIndex: 1,
  ...
  methods: {
    postBillAudit: dwzsjhgl.billAudit,
    // 审核 对话框
    billAudit() {
