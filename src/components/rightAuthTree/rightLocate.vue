...
<template>
  <div class="location-search">
    ...
    <!-- <legend>定位</legend> -->
    <div class="wrap">
      <el-input v-model="inputVal" size="mini" placeholder="请输入代码或拼音" class="input-search" @change="clearCurrentIndexRight" />
      <!-- <template> -->
      <!-- <div class="radio-type"> -->
      <el-radio v-model="searchType" label="code">代码</el-radio>
      <el-radio v-model="searchType" label="spell">拼音</el-radio>
      <!-- </div> -->
      <!-- </template> -->
      <el-button size="mini" class="next" @click="nextPositionRight">下一个</el-button>
    </div>
    <!-- </fieldset> -->
  </div>
</template>
